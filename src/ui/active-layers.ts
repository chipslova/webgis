        ...
        itemsHtml += `
          <div class="active-layer-item ${!isGeePoiVis ? 'is-hidden' : ''}">
            <div class="active-layer-main">
              ...
              <button class="icon-btn-sm btn-remove-gee-poi" title="Hapus / Nonaktifkan Layer POI">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 6 6 18M6 6l12 12"/></svg>
              </button>
            </div>
          </div>
        ...
        itemsHtml += `
          <div class="active-layer-item ${!isGeeLstVis ? 'is-hidden' : ''}">
            <div class="active-layer-main">
              ...
              <button class="icon-btn-sm btn-remove-gee-lst" title="Hapus / Nonaktifkan LST">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 6 6 18M6 6l12 12"/></svg>
              </button>
            </div>
            ${isGeeLstVis ? `
        ...
        itemsHtml += `
          <div class="active-layer-item ${!isGeeElvVis ? 'is-hidden' : ''}">
            <div class="active-layer-main">
              ...
              <button class="icon-btn-sm btn-remove-gee-elv" title="Hapus / Nonaktifkan Elevasi">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 6 6 18M6 6l12 12"/></svg>
              </button>
            </div>
            ${isGeeElvVis ? `
        ...
        itemsHtml += `
          <div class="active-layer-item ${!isGeeLcVis ? 'is-hidden' : ''}">
            <div class="active-layer-main">
              ...
              <button class="icon-btn-sm btn-remove-gee-lc" title="Hapus / Nonaktifkan Land Cover">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 6 6 18M6 6l12 12"/></svg>
              </button>
            </div>
            ${isGeeLcVis ? `
